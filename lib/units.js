...
const Neutral = Enum.IntEnum('Neutral', {
  // Neutral units.
...
const Protoss = Enum.IntEnum('Protoss', {
  // Protoss units.
  Adept: 311,
  AdeptPhaseShift: 801,
  Archon: 141,
...
const Terran = Enum.IntEnum('Terran', {
  // Terran units.
  Armory: 29,
  AutoTurret: 31,
  Banshee: 55,
...
function get_unit_type(unit_id) {
  const races = [Neutral, Protoss, Terran, Zerg]
  for (let i = 0; i < races.length; i++) {
    try {
      return races[i](unit_id)
    } catch (error) {
      //pass
    }
  }
